...
/* =========================================================
   CLIENT DETAILS SYSTEM — DESIGN 03
   ========================================================= */
...
(function () {
    ...
    if (arrivalDetails) {
        ...
        const detailItems =
            arrivalDetails.querySelectorAll(".detail-item");

        if (detailItems[0]) {
            detailItems[0].querySelector("strong").textContent =
                client.arrivalDate;
        }

        if (detailItems[1]) {
            detailItems[1].querySelector("strong").textContent =
                client.arrivalTime;
        }

        if (detailItems[2]) {
            detailItems[2].querySelector("strong").textContent =
                client.address;
        }
    }
    ...
    const familyName =
        document.querySelector(".family-name");
    ...
    const festivalEvents =
        document.querySelectorAll(".festival-event");

    if (festivalEvents.length >= 5) {

        /* 01 — Ganpati Arrival */
        const arrivalEvent =
            festivalEvents[0].querySelector(".event-content p");

        if (arrivalEvent) {
            arrivalEvent.textContent =
        ...
        /* 02 — Sthapana */
        const sthapanaEvent =
            festivalEvents[1].querySelector(".event-content p");

        if (sthapanaEvent) {
            sthapanaEvent.textContent =
                client.sthapanaDate + " • " + client.sthapanaTime;
        }


        /* 03 — Aarti */
        const aartiEvent =
            festivalEvents[2].querySelector(".event-content p");

        if (aartiEvent) {
            aartiEvent.textContent =
                client.aartiTime;
        }


        /* 04 — Mahaprasad */
        const mahaprasadEvent =
            festivalEvents[3].querySelector(".event-content p");
        ...
        /* 05 — Visarjan */
        const visarjanEvent =
            festivalEvents[4].querySelector(".event-content p");

        if (visarjanEvent) {
            visarjanEvent.textContent =
                client.visarjanDate + " • " + client.visarjanTime;
        }
    }
    ...
    const locationAddress =
        document.querySelector(".location-details p");

    if (locationAddress) {
        locationAddress.innerHTML =
            client.address.replace(/, /g, "<br>");
    }
